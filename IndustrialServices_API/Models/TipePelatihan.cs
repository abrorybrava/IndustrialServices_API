...
namespace IndustrialServices_API.Models
{
    public class TipePelatihan
    {
        ...
        public List<TipePelatihanModel> GetAllTipePelatihanbyBK(string bidang_keahlian)
        {
            List<TipePelatihanModel> tipePelatihanList = new List<TipePelatihanModel>();
            try
            {
                string query = "SELECT * FROM Tipe_Pelatihan WHERE bidang_keahlian = @bk AND status != 0";
                SqlCommand command = new SqlCommand(query, _connection);
                command.Parameters.AddWithValue("@bk", bidang_keahlian);
                _connection.Open();
                SqlDataReader reader = command.ExecuteReader();
                while (reader.Read())
                {
        ...
        public void InsertTipePelatihan(TipePelatihanModel tipePelatihanModel)
        {
            try
            {
                string query = "INSERT INTO Tipe_Pelatihan (tipe_pelatihan, bidang_keahlian, status) VALUES (@tipe, @bidang, @status)";
                SqlCommand command = new SqlCommand(query, _connection);
                command.Parameters.AddWithValue("@tipe", tipePelatihanModel.tipe_pelatihan);
                command.Parameters.AddWithValue("@bidang", tipePelatihanModel.bidang_keahlian);
        ...
        public void UpdateTipePelatihan(TipePelatihanModel tipePelatihanModel)
        {
            try
            {
                string query = "UPDATE Tipe_Pelatihan SET tipe_pelatihan = @tipe, bidang_keahlian = @bidang WHERE id_tipe_pelatihan = @id";
                SqlCommand command = new SqlCommand(query, _connection);
                command.Parameters.AddWithValue("@tipe", tipePelatihanModel.tipe_pelatihan);
                command.Parameters.AddWithValue("@bidang", tipePelatihanModel.bidang_keahlian);
        ...
        public TipePelatihanModel GetTipePelatihanById(int id)
        {
            ...
            try
            {
                ...
                if (reader.Read())
                {
                    ...
                    tipePelatihanModel.bidang_keahlian = reader["bidang_keahlian"].ToString();
        ...
        public bool CheckNama(TipePelatihanModel tipePelatihan)
        {
            try
            {
                string query = "SELECT * FROM Tipe_Pelatihan WHERE tipe_pelatihan = @p1 AND status != 0";
                SqlCommand command = new SqlCommand(query, _connection);
        ...
        public bool CheckNamaEdit(TipePelatihanModel tipePelatihan)
        {
            try
            {
                string query = "SELECT * FROM Tipe_Pelatihan WHERE id_tipe_pelatihan != @p1 AND tipe_pelatihan = @p2 AND status != 0";
                SqlCommand command = new SqlCommand(query, _connection);
